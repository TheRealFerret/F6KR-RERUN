...
function onUpdate()
	...
	noteTweenY('NOTEMOVE9', 8, 120, 0.5, 'Linear')
	noteTweenY('NOTEMOVE10', 9, 120, 0.5, 'Linear')
	noteTweenY('NOTEMOVE11', 10, 120, 0.5, 'Linear')
	noteTweenY('NOTEMOVE12', 11, 120, 0.5, 'Linear')
	...
	noteTweenY('NOTEMOVE9', 8, 480, 0.5, 'Linear')
	noteTweenY('NOTEMOVE10', 9, 480, 0.5, 'Linear')
	noteTweenY('NOTEMOVE11', 10, 480, 0.5, 'Linear')
	noteTweenY('NOTEMOVE12', 11, 480, 0.5, 'Linear')
	doTweenAlpha('AlphaTween1', 'healthBarBG', 0, 0.25)
	doTweenAlpha('AlphaTween2', 'healthBar', 0, 0.25)
	doTweenAlpha('AlphaTween3', 'scoreTxt', 0, 0.25)
	doTweenAlpha('AlphaTween4', 'iconP1', 0, 0.25)
	...
	noteTweenY('NOTEMOVE9', 8, 50, 0.5, 'Linear')
	noteTweenY('NOTEMOVE10', 9, 50, 0.5, 'Linear')
	noteTweenY('NOTEMOVE11', 10, 50, 0.5, 'Linear')
	noteTweenY('NOTEMOVE12', 11, 50, 0.5, 'Linear')
	...
	noteTweenY('NOTEMOVE9', 8, 570, 0.5, 'Linear')
	noteTweenY('NOTEMOVE10', 9, 570, 0.5, 'Linear')
	noteTweenY('NOTEMOVE11', 10, 570, 0.5, 'Linear')
	noteTweenY('NOTEMOVE12', 11, 570, 0.5, 'Linear')
	doTweenAlpha('AlphaTween1', 'healthBarBG', 1, 0.25)
	doTweenAlpha('AlphaTween2', 'healthBar', 1, 0.25)
	doTweenAlpha('AlphaTween3', 'scoreTxt', 1, 0.25)
	doTweenAlpha('AlphaTween4', 'iconP1', 1, 0.25)
