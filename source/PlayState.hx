...
class PlayState extends MusicBeatState
{
	...
	private var pendulumKey:Array<FlxKey>;
	...
	public var sonicHUDStyles:Map<String, String> = [
		...
		var sky:BGSprite;
		var backbush:BGSprite;
		var treeback:BGSprite;
		var topbushes:BGSprite;
	...
	var textFart:FlxText;
	var fart:FlxSprite;
	var fart2:FlxSprite;
	var sponge:FlxSprite;
	var sponge2:FlxSprite;
	var black:FlxSprite;
	var idk:Bool = false;
	var fuck:FlxBar;
	...
	//cheeker
	var bottomBoppersCheek:FlxSprite;
	...
	//micheal mouse
	var grain:FlxSprite;
	var cinematicBarsMouse:Map<String, FlxSprite> = ["top" => null, "bottom" => null,];
	...
	var dodgingMouse:Bool = false;
	var canDodgeMouse:Bool = true;

	var priAnim:Bool = false;
	...
	override public function create()
	{
		...
		dodgeKey = ClientPrefs.copyKey(ClientPrefs.keyBinds.get('gp_dodge'));
		pendulumKey = ClientPrefs.copyKey(ClientPrefs.keyBinds.get('gp_pendulum'));
		...
		var cover:BGSprite = new BGSprite('expurgation/cover', -240, 755, 1, 1);
		var hole:BGSprite = new BGSprite('expurgation/Spawnhole_Ground_BACK', -10, 530, 1, 1);
		var converHole:BGSprite = new BGSprite('expurgation/Spawnhole_Ground_COVER', -53,578, 1, 1);
		...
		if (curSong.toLowerCase() == 'fatality'||curSong.toLowerCase() == 'run'||curSong.toLowerCase() == 'onslaught')
		...
		switch (curStage)
		{
			...
			case 'freeplay':
				...
				charBackdrop = new FlxBackdrop(Paths.image('recursed/daveScroll'), XY, 1, 1);
			...
			case 'pretender': // pink stage
				...
				cloud1 = new FlxBackdrop(Paths.image('amogus/mira/pretender/cloud 1'), XY, 1, 1);
				...
				cloud2 = new FlxBackdrop(Paths.image('amogus/mira/pretender/cloud 2'), XY, 1, 1);
				...
				cloud3 = new FlxBackdrop(Paths.image('amogus/mira/pretender/cloud 3'), XY, 1, 1);
				...
				cloud4 = new FlxBackdrop(Paths.image('amogus/mira/pretender/cloud 4'), XY, 1, 1);
				...
				cloudbig = new FlxBackdrop(Paths.image('amogus/mira/pretender/bigcloud'), XY, 1, 1);
			...
			case 'reactor2':
				...
				toogusorange.antialiasing = ClientPrefs.globalAntialiasing;
				add(toogusorange);
				...
				toogusblue.antialiasing = ClientPrefs.globalAntialiasing;
				add(toogusblue);
				...
				tooguswhite.antialiasing = ClientPrefs.globalAntialiasing;
				add(tooguswhite);
			...
			case 'cargo': // double kill
				...
				cargoDark.antialiasing = ClientPrefs.globalAntialiasing;
				...
				cargoAirsip.antialiasing = ClientPrefs.globalAntialiasing;
				...
				cargoDarkFG.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'plantroom': // pink stage
				...
				pinkVignette.antialiasing = ClientPrefs.globalAntialiasing;
				...
				pinkVignette2.antialiasing = ClientPrefs.globalAntialiasing;
				...
				heartsImage.antialiasing = ClientPrefs.globalAntialiasing;
				heartsImage.alpha = 0;
				...
				cloud1 = new FlxBackdrop(Paths.image('amogus/mira/cloud 1'), XY, 1, 1);
				cloud1.setPosition(0, -1000);
				cloud1.updateHitbox();
				cloud1.antialiasing = ClientPrefs.globalAntialiasing;
				cloud1.scrollFactor.set(1, 1);
				...
				cloud2 = new FlxBackdrop(Paths.image('amogus/mira/cloud 2'), XY, 1, 1);
				cloud2.setPosition(0, -1200);
				cloud2.updateHitbox();
				cloud2.antialiasing = ClientPrefs.globalAntialiasing;
				cloud2.scrollFactor.set(1, 1);
				...
				cloud3 = new FlxBackdrop(Paths.image('amogus/mira/cloud 3'), XY, 1, 1);
				cloud3.setPosition(0, -1400);
				cloud3.updateHitbox();
				cloud3.antialiasing = ClientPrefs.globalAntialiasing;
				cloud3.scrollFactor.set(1, 1);
				...
				cloud4 = new FlxBackdrop(Paths.image('amogus/mira/cloud 4'), XY, 1, 1);
				cloud4.setPosition(0, -1600);
				cloud4.updateHitbox();
				cloud4.antialiasing = ClientPrefs.globalAntialiasing;
				cloud4.scrollFactor.set(1, 1);
				...
				cloudbig = new FlxBackdrop(Paths.image('amogus/mira/bigcloud'), XY, 1, 1);
				cloudbig.setPosition(0, -1200);
				cloudbig.updateHitbox();
				cloudbig.antialiasing = ClientPrefs.globalAntialiasing;
				cloudbig.scrollFactor.set(1, 1);
				...
				greymira.antialiasing = ClientPrefs.globalAntialiasing;
				...
				ventNotSus.antialiasing = ClientPrefs.globalAntialiasing;
				...
				cyanmira.antialiasing = ClientPrefs.globalAntialiasing;
				...
				longfuckery.antialiasing = ClientPrefs.globalAntialiasing;
				...
				noootomatomongus.antialiasing = ClientPrefs.globalAntialiasing;
				...
				oramira.antialiasing = ClientPrefs.globalAntialiasing;
				...
				pretenderDark.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'warehouse':
				...
				torfloor.antialiasing = ClientPrefs.globalAntialiasing;
				...
				torwall.antialiasing = ClientPrefs.globalAntialiasing;
				...
				torglasses.antialiasing = ClientPrefs.globalAntialiasing;
				...
				windowlights.antialiasing = ClientPrefs.globalAntialiasing;
				...
				leftblades.antialiasing = ClientPrefs.globalAntialiasing;
				...
				rightblades.antialiasing = ClientPrefs.globalAntialiasing;
				...
				ROZEBUD_ILOVEROZEBUD_HEISAWESOME.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'void':
			    ...
			    basementvoid.antialiasing = ClientPrefs.globalAntialiasing;
			    ...
			    chestvoid.antialiasing = ClientPrefs.globalAntialiasing;
			    ...
			    drvoid.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'chest':
		        ...
		        GFdisappointed.antialiasing = ClientPrefs.globalAntialiasing;
		        ...
		        trashitem.antialiasing = ClientPrefs.globalAntialiasing;
		        ...
		        chestidle.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'chamber':
				...
				fleetwaybgshit.antialiasing = ClientPrefs.globalAntialiasing;
				fleetwaybgshit.scrollFactor.set(1.1, 1);

				emeraldbeam = new FlxSprite(0, -1376.95 - 200);
				emeraldbeam.antialiasing = ClientPrefs.globalAntialiasing;
				...
				emeraldbeamyellow.antialiasing = ClientPrefs.globalAntialiasing;
				...
				emeralds.antialiasing = ClientPrefs.globalAntialiasing;
				...
				thechamber.antialiasing = ClientPrefs.globalAntialiasing;
				...
				pebles.antialiasing = ClientPrefs.globalAntialiasing;
				...
				porker.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'FAKERSTAGE':
				...
				pillar2.antialiasing = ClientPrefs.globalAntialiasing;
				...
				pillar1.antialiasing = ClientPrefs.globalAntialiasing;
				...
				flower1.antialiasing = ClientPrefs.globalAntialiasing;
				...
				flower2.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'EXEStage':
				...
				treething.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'LordXStage':
				...
				hills1.antialiasing = ClientPrefs.globalAntialiasing;
				...
				hills2.antialiasing = ClientPrefs.globalAntialiasing;
				...
				smallflower.antialiasing = ClientPrefs.globalAntialiasing;
				...
				smallflowe2.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'slaught' :
				...
				add(ground);
			case 'ajenjenj':
				fart = new FlxSprite().loadGraphic(Paths.image("ajenjenj/sky"));
				add(fart);
			
				fart2 = new FlxSprite().loadGraphic(Paths.image("ajenjenj/inside"));
				add(fart2);
			
				sponge = new FlxSprite(320, 655).loadGraphic(Paths.image("ajenjenj/dead"));
				sponge.scale.set(0.8, 0.8);
				sponge.updateHitbox(); 
				add(sponge);
				
				sponge2 = new FlxSprite(320, 655).loadGraphic(Paths.image("ajenjenj/deadOverlay"));
				sponge2.scale.set(0.8, 0.8);
				sponge2.updateHitbox(); 
				
				black = new FlxSprite().makeGraphic(1280, 720, 0xFF000000);
				add(black);
				black.alpha = 0;
				black.scrollFactor.set();
				black.setGraphicSize(Std.int(black.width / defaultCamZoom));

				camHUD.alpha = 0;
				camNotes.alpha = 0;
			case 'loggo2': // dark loggo
				var bg:BGSprite = new BGSprite('amogus/space', 0, 200, 0.8, 0.8);
				add(bg);
				bg.setGraphicSize(Std.int(bg.width * 3));
				bg.antialiasing = false;

				var stageFront:BGSprite = new BGSprite('amogus/placeholder Hell', -650, 600, 0.9, 0.9);
				...
				peopleloggo.frames = Paths.getSparrowAtlas('amogus/people');
				...
				add(peopleloggo);
			case 'clubroomevil':
				space = new FlxBackdrop(Paths.image('doki/bigmonika/Sky'));
				...
				var bg:BGSprite = new BGSprite('doki/bigmonika/BG', -250, -167, 0.4, 0.6);
				add(bg);

				if (!ClientPrefs.lowQuality)
				{
					windowlight = new BGSprite('doki/bigmonika/WindowLight', -250, -167, 0.4, 0.6);
					add(windowlight);
	
					lightontopofall = new BGSprite('doki/bigmonika/lights', -250, -167, 0.4, 0.6);
					lightontopofall.blend = SCREEN;

					dokiBackdrop = new FlxBackdrop(Paths.image('doki/scrollingBG'));
					dokiBackdrop.velocity.set(-40, -40);
					dokiBackdrop.antialiasing = ClientPrefs.globalAntialiasing;
					dokiBackdrop.alpha = 0.001;
					dokiBackdrop.shader = new ColorMaskShader(0xFFFDFFFF, 0xFFFDDBF1);
					add(dokiBackdrop);
				}

				var bg:BGSprite = new BGSprite('doki/bigmonika/FG', -328, -115);
				add(bg);
			...
			case 'issue':
				...
				var bottomBoppers = new FlxSprite(153, 186);
				bottomBoppers.frames = Paths.getSparrowAtlas('fortress/lol');
			...
			case 'cant-run-xd':
				...
				var sky:BGSprite = new BGSprite('Exe/run/sky', -600, -200, 1.0, 1.0);
				genesis.add(sky);

				var grassback:BGSprite = new BGSprite('Exe/run/GrassBack', -600, -200, 1.0, 1.0);
				genesis.add(grassback);

				var trees:BGSprite = new BGSprite('Exe/run/trees', -600, -200, 1.0, 1.0);
				genesis.add(trees);

				var grass:BGSprite = new BGSprite('Exe/run/Grass', -600, -200, 1.0, 1.0);
				genesis.add(grass);

				var treesfront:BGSprite = new BGSprite('Exe/run/TreesFront', -600, -200, 1.0, 1.0);
				genesis.add(treesfront);

				var topoverlay:BGSprite = new BGSprite('Exe/run/TopOverlay', -600, -200, 1.0, 1.0);
				genesis.add(topoverlay);

				pickle = new FlxSprite(-428.5 + 50 + 700, -449.35 + 25 + 392 + 105 + 50).loadGraphic(Paths.image("Exe/run/GreenHill"));
			...
			case 'trioStage':
				...
				sky = new BGSprite('Exe/Phase3/normal/glitch', -621.1, -395.65, 1.0, 1.0);
				sky.active = false;
				add(sky);

				backbush = new BGSprite('Exe/Phase3/normal/BackBush', -621.1, -395.65, 1.0, 1.0);
				backbush.active = false;
				add(backbush);

				treeback = new BGSprite('Exe/Phase3/normal/TTTrees', -621.1, -395.65, 1.0, 1.0);
				treeback.active = false;
				add(treeback);

				topbushes = new BGSprite('Exe/Phase3/normal/TopBushes', -621.1, -395.65, 1.0, 1.0);
				topbushes.active = false;
				add(topbushes);

				fgTree1 = new BGSprite('Exe/Phase3/normal/FGTree1', -621.1, -395.65, 0.7, 0.7);
				fgTree1.active = false;


				fgTree2 = new BGSprite('Exe/Phase3/normal/FGTree2', -621.1, -395.65, 0.7, 0.7);
				fgTree2.active = false;

				p3staticbg = new FlxSprite(0, 0).loadGraphic(Paths.image("Exe/Phase3/NewTitleMenuBg"));
				p3staticbg.frames = Paths.getSparrowAtlas('Exe/Phase3/NewTitleMenuBG');
				...
				backtreesXeno = new BGSprite('Exe/Phase3/xeno/BackTrees', -621.1, -395.65, 1.0, 1.0);
				backtreesXeno.active = false;
				backtreesXeno.visible = false;
				add(backtreesXeno);

				grassXeno = new BGSprite('Exe/Phase3/xeno/Grass', -621.1, -395.65, 1.0, 1.0);
				grassXeno.active = false;
				grassXeno.visible = false;
				add(grassXeno);
			case 'omen': 
				var	background:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/omen/BadOmen_Sky'));
				background.antialiasing = ClientPrefs.globalAntialiasing;
				background.screenCenter();
				background.setGraphicSize(Std.int(background.width * 1.5));
				add(background);

				var dawall:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/omen/BadOmen_Wall'));
				dawall.antialiasing = ClientPrefs.globalAntialiasing;
				dawall.screenCenter();
				dawall.setGraphicSize(Std.int(dawall.width * 1.5));
				add(dawall);

				var pillars:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/omen/BadOmen_Pillars'));
			...
			case 'mugen':
				...
				var background:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/Hard2Break_Castle'));
				background.antialiasing = ClientPrefs.globalAntialiasing;
				background.screenCenter();
				background.setGraphicSize(Std.int(background.width * 1.5));
				...
				bottomBoppersCheek = new FlxSprite();
				bottomBoppersCheek.frames = Paths.getSparrowAtlas('cheeky/crowd');
				bottomBoppersCheek.animation.addByPrefix('idle', 'crowd', 24, false);
				bottomBoppersCheek.screenCenter();
				bottomBoppersCheek.y += 45;
				//	bottomBoppersCheek.scrollFactor.set(0.9, 0.9);
				bottomBoppersCheek.antialiasing = ClientPrefs.globalAntialiasing;
				bottomBoppersCheek.setGraphicSize(Std.int(bottomBoppersCheek.width * 1.3));
				add(bottomBoppersCheek);

				frontDudes = new FlxSprite();
				frontDudes.frames = Paths.getSparrowAtlas('cheeky/crowd2');
			...
			case 'meat':
				var background:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/MeatPlant_Back_RainySky'));
				background.antialiasing = FlxG.save.data.antialasing;
				background.screenCenter();
				background.setGraphicSize(Std.int(background.width * 1.5));
				add(background);

				var floor:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/MeatPlant_Floor'));
				...
				truck = new FlxSprite();
				truck.frames = Paths.getSparrowAtlas('cheeky/truck_go_brr');
				...
				var thing:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/MeatPlant_Props'));
				thing.antialiasing = FlxG.save.data.antialasing;
				thing.screenCenter();
				thing.setGraphicSize(Std.int(thing.width * 1.25));
				add(thing);
			case 'hell': 
				var background:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/Pankreas_Back_Sky'));
				background.antialiasing = FlxG.save.data.antialasing;
				background.screenCenter();
				background.setGraphicSize(Std.int(background.width * 1.5));
				add(background);

				var backhill:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/Pankreas_Back_Hills'));
				backhill.antialiasing = FlxG.save.data.antialasing;
				backhill.screenCenter();
				backhill.setGraphicSize(Std.int(backhill.width * 1.5));
				add(backhill);

				var hills:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/Pankreas_Hills'));
				hills.antialiasing = FlxG.save.data.antialasing;
				hills.screenCenter();
				hills.setGraphicSize(Std.int(hills.width * 1.5));
				add(hills);

				var lake:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/Pankreas_Red_River'));
				lake.antialiasing = FlxG.save.data.antialasing;
				lake.screenCenter();
				lake.setGraphicSize(Std.int(lake.width * 1.5));
				add(lake);

				var platform:FlxSprite = new FlxSprite().loadGraphic(Paths.image('cheeky/Pancreas_Platform'));
				platform.antialiasing = FlxG.save.data.antialasing;
				platform.screenCenter();
				platform.setGraphicSize(Std.int(platform.width * 1.5));
				add(platform);

				backgthing = new FlxSprite().loadGraphic(Paths.image('cheeky/MeatPlant_Back_RainySky'));
				...
				thingy = new FlxSprite().loadGraphic(Paths.image('cheeky/MeatPlant_Floor'));
				thingy.antialiasing = FlxG.save.data.antialasing;
				thingy.screenCenter();
				thingy.setGraphicSize(Std.int(thingy.width * 1.5));
				add(thingy);
					
				floorthing = new FlxSprite().loadGraphic(Paths.image('cheeky/MeatPlant_Props'));
				...
				weirdstatic.frames = Paths.getSparrowAtlas('cheeky/Static');
				add(weirdstatic);
				remove(weirdstatic);

				statttt = new FlxSprite(0,0);
				statttt.frames = Paths.getSparrowAtlas('cheeky/Static');
				add(statttt);
				remove(statttt);
			case 'bobux':
				var nosexi:BGSprite = new BGSprite('infidelity/backgrounds/Destruido', -600, -200);
				nosexi.antialiasing = ClientPrefs.globalAntialiasing;
				nosexi.updateHitbox();
				add(nosexi);

				thewhite = new FlxSprite().makeGraphic(FlxG.width, FlxG.height, FlxColor.WHITE);
				thewhite.setGraphicSize(Std.int(thewhite.width * 10));
				add(thewhite);
				thewhite.alpha = 0.0001;
		...
		switch(Paths.formatToSongPath(SONG.song))
		{
			...
			case 'infitrigger':
				...
				vtanSong = true;
			case 'honorbound'|'strongmann'|'eyelander'|'skill-issue':
				tf2Font = true;
			...
			case 'triple-trouble':
				...
				camHUD.alpha = 0;
				camNotes.alpha = 0;
			case 'cycles'|'too-slow'|'too-slow-encore'|'execution'|'you-cant-run':
				skipCountdown = true;
			case 'fatality':
				FlxG.fullscreen = false;
				noCountdown = true;
			case 'run'|'onslaught':
				FlxG.fullscreen = false;
			case 'epiphany':
				GameOverSubstate.characterName = 'bigmonika-dead';
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx-bigmonika';
				GameOverSubstate.loopSoundName = 'gameOver-doki';
				GameOverSubstate.endSoundName = 'gameOverEnd-doki';
			case 'bombastic'|'phantasm'|'fnfgirl':
				opponentChart = false;
			case 'bad-eggroll':
				GameOverSubstate.characterName = 'bob-playable';
			case 'cornucopia':
				GameOverSubstate.characterName = 'bob-playable';
				GameOverSubstate.loopSoundName = 'gameOver-cheekbob';
				GameOverSubstate.endSoundName = 'gameOverEnd-cheekbob';
				skipCountdown = true;
			case 'unknown-suffering'|'unknown-suffering-remix':
				chrom = new ChromaticAberrationEffect();

				addShaderToCamera("camNotes", chrom);
				...
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx-mouse';
				GameOverSubstate.loopSoundName = 'gameOver-mouse';
				GameOverSubstate.endSoundName = 'gameOverEnd-mouse';
		}
		...
		switch(curStage)
		{
			...
			case 'reactor2':
				...
				mainoverlay.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'cargo':
				...
				lightoverlayDK.antialiasing = ClientPrefs.globalAntialiasing;
				...
				defeatDKoverlay.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'warehouse':
				...
				montymole.antialiasing = ClientPrefs.globalAntialiasing;
				...
				torlight.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'loggo2':
				...
				darknessLojo.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'trioStage':
				...
				add(fgTree1);
				add(fgTree2);
				addCharacterToList('bf-perspective-right', 0);
				addCharacterToList('BEAST', 1);
				addCharacterToList('bf-mirror', 0);
				addCharacterToList('knux', 1);
				addCharacterToList('bf-perspective-left', 0);
				addCharacterToList('BEAST-RIGHT', 1);
				addCharacterToList('eggdick', 1);
			case 'mugen':
				add(frontDudes);
			case 'bobux':
				camZooming = false;
				singingTurnsOnCamZoom = false;
			
				blackFuck = new FlxSprite().makeGraphic(FlxG.width * 3, FlxG.height * 3, FlxColor.fromRGB(0, 0, 0));
		...
		if (ClientPrefs.gfSkin == 'gf'||stageData.hide_girlfriend||curStage == 'chantown'||curStage == 'pibbified'||curStage == 'neo2'||curStage == 'void1'||curStage == 'void'||curStage == 'ajenjenj'||
			curStage == 'defeatold'||curStage == 'clubroomevil'||curStage == 'iriosworld'||curStage == 'funnystage'||curStage == 'trioStage'||curStage == 'cave'||curStage == 'unkown'||
			curStage == 'bonus')
			gfVersion = SONG.gfVersion;
		else
			gfVersion = ClientPrefs.gfSkin;
		...
		switch (ClientPrefs.gfSkin)
		{
			case 'gf-exe':
				if (gfVersion == 'gf-exe' && curSong.toLowerCase() != 'faker'||gfVersion == 'gf-exe' && curSong.toLowerCase() != 'black sun'){
					if (curStage == 'honor')
						gf.y += 250;
					else if (curStage == 'iglesia'){
						gf.x += 100;
						gf.y += 200;
					}
					else if (curStage == 'reactor2'){
						gf.x += 100;
						gf.y += 75;
					}
					else if (curStage == 'hillzoneDarkSonic'){
						gf.x += 150;
						gf.y += 75;
					}
					else if (curStage == 'zardy'){
						gf.x += 100;
						gf.y += 50;
					}
					...
					else if (curStage == 'nevada'){
						gf.x += 225;
					}
					else if (curStage == 'alley-balls'||curStage == 'alley-balls-hqr'){
						gf.x += 225;
						gf.y += 65;
					}
					else {
			...
			case 'gf-christmas':
				if (gfVersion == 'gf-christmas'){
					if (curStage == 'auditorHell'){
						gf.y -= 250;
					}
					else if (curStage == 'FAKERSTAGE'||curStage == 'EXEStage'){
						gf.x -= 300;
						gf.y -= 45;
					}
					else if (curStage == 'reactor2'){
					...
					else if (curStage == 'honor'){
						gf.x -= 150;
						gf.y += 175;
					}
					else if (curStage == 'barnblitz-heavy'){
						gf.x -= 150;
					}
					else if (curStage == 'iglesia'){
						gf.y += 100;
			...
			case 'gf-tf2':
				if (gfVersion == 'gf-tf2' && curSong.toLowerCase() != 'honorbound'||gfVersion == 'gf-tf2' && curSong.toLowerCase() != 'eyelander'||gfVersion == 'gf-tf2' && curSong.toLowerCase() != 'strongmann'){
					if (curStage == 'alley-balls'||curStage == 'alley-balls-hqr'){
						gf.x += 250;
						gf.y -= 200;
					}
					else if (curStage == 'nevada'){
		...
		if (ClientPrefs.happybob && curStage == 'hellstage')
			dad = new Character(0, 0, 'happybob');
		else
		...
		if (ClientPrefs.bfSkin == 'bf'||curStage == 'chantown'||curStage == 'neo2'||curStage == 'void1'||curStage == 'DDDDD'||curStage == 'fatality'||
			curStage == 'pretender'||curStage == 'idk'||curStage == 'warehouse'||curStage == 'fleet'||curStage == 'cave'||curStage == 'bonus'||curStage == 'void'||
			curStage == 'ajenjenj'||curStage == 'iriosworld'||curStage == 'funnystage')
			bfVersion = SONG.player1;
		else
			bfVersion = ClientPrefs.bfSkin;
		...
		if (curSong.toLowerCase() == 'darnell wet fart')
			gf.visible = false;
		...
		if(curStage == 'defeat' && !opponentChart|| curStage == 'defeatold' && !opponentChart)
			STRUM_X = -278;
		else
			STRUM_X = 42;
		...
		if (!pussyMode) {
			...
			if (/*SONG.player2 == 'hypno-two' ||*/ SONG.player2 == 'abomination-hypno' || tranceActive || pendulumMode)
			{
				...
				pendulum.antialiasing = ClientPrefs.globalAntialiasing; // fuck you again
		...
		if (curStage == 'bobux'){
			grain = new FlxSprite();
			grain.frames = Paths.getSparrowAtlas("infidelity/grain");
		...
		if (SONG.song.toLowerCase() == 'acceptance' && curStage == 'chest')
			...
			IsaacInChest.antialiasing = ClientPrefs.globalAntialiasing;
			...
			end.antialiasing = ClientPrefs.globalAntialiasing;
			end.screenCenter();
		...
		if (curSong.toLowerCase() == 'darnell wet fart'){
			textFart = new FlxText();
			textFart.cameras = [camOther];
			textFart.setFormat(Paths.font("sponge.ttf"), 24, 0xFF0000FF);
			textFart.screenCenter();
			textFart.color = 0xFF0000FF;
			textFart.y = healthBarBG.y - Std.int(textFart.height * 2);
			add(textFart);

			var fearBarBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image("ajenjenj/bar"));
			...
			bluevg = new FlxSprite().loadGraphic(Paths.image("ajenjenj/blueVG"));
			bluevg.alpha = 0;
			bluevg.cameras = [camHUD];
		...
		if (curSong.toLowerCase() == 'platforming')
		...
		if (opponentChart && curStage == 'bobux')
			blackFuck.cameras = [camHUD];
		else
			blackFuck.cameras = [camOther];
		...
		switch (curSong.toLowerCase())
		{
			case 'bad eggroll'|'cornucopia':
				...
				weirdstatic.antialiasing = ClientPrefs.globalAntialiasing;
				...
				weirdstatic.cameras = [camOther];
				add(weirdstatic);
				weirdstatic.alpha = 0.00001;
		...
		else
		{
			...
			switch (daSong)
			{
				...
				case 'acceptance':
				    ...
				    misseffect.antialiasing = ClientPrefs.globalAntialiasing;
					...
					bluebabyintro.antialiasing = ClientPrefs.globalAntialiasing;
	...
	function cacheCountdown()
	{
		...
		introAssets.set('mouse', ['ready-mouse', 'set-mouse', 'go-mouse']);
		...
		if (curStage == 'bobux') introAlts = introAssets.get('mouse');
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				if(curSong.toLowerCase() == 'too slow dside')
					introAlts = introAssets.get('dside');
				if(curStage == 'bobux')
					introAlts = introAssets.get('mouse');
	...
	public function updateScore(miss:Bool = false)
	{
		...
		// 	{
				...
				+ ' | Misses: ' + songMisses; 
				if (missLimited && curStage != 'defeatold') scoreTxt.text += ' / $missLimitCount';
	...
	function startSong():Void
	{
		...
		if (curSong.toLowerCase() == 'unknown suffering')
			barSongLength = 121000;
		if (curSong.toLowerCase() == 'unknown suffering remix')
			barSongLength = 151000;
		...
		for (section in noteData)
		{
			for (songNotes in section.sectionNotes)
			{
				...
				{ // Real notes
					...
					if (SONG.player2 == "fatal-sonic" && !gottaHitNote && !opponentChart)
						swagNote.texture = "FATALNOTE_assets";
					if (SONG.player2 == "fatal-sonic" && gottaHitNote && opponentChart)
						swagNote.texture = "FATALNOTE_assets";
					if (SONG.song.toLowerCase() == 'you cant run' && curStep == 528)
						swagNote.texture = "SONICNOTE_assets";
					if (SONG.song.toLowerCase() == 'you cant run' && curStep == 784)
					...
					if(floorSus > 0) {
						for (susNote in 0...floorSus+1)
						{
							...
							if (SONG.player2 == "fatal-sonic" && gottaHitNote && opponentChart)
								sustainNote.texture = "FATALNOTE_assets";
							if (SONG.song.toLowerCase() == 'you cant run' && curStep == 528)
								sustainNote.texture = "SONICNOTE_assets";
							if (SONG.song.toLowerCase() == 'you cant run' && curStep == 784)
	...
	function eventPushed(event:EventNote) {
		switch(event.event) {
			case 'Do Syringe':
				if (spaceBar == null && !pussyMode)
				{
					spaceBar = new FlxSprite(0, 0);
					spaceBar.frames = Paths.getSparrowAtlas('infidelity/mechanics/warning');
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...Note.ammo[mania])
		{
			...
			if (player < 1)
			{
				if(!ClientPrefs.opponentStrums || curStage == 'defeat'  && !opponentChart|| curStage == 'defeatold' && !opponentChart) targetAlpha = 0;
				else if(ClientPrefs.middleScroll) targetAlpha = 0.35;
			}

			var babyArrow:StrumNote = new StrumNote(ClientPrefs.middleScroll ? STRUM_X_MIDDLESCROLL : STRUM_X, strumLine.y, i, player);
			babyArrow.downScroll = ClientPrefs.downScroll;
			if (!isStoryMode && !skipArrowStartTween && mania > 1 && curSong.toLowerCase() != 'fatality' && curSong.toLowerCase() != 'you cant run')
			{
				//babyArrow.y -= 10;
				babyArrow.alpha = 0;
			...
			if (player == 1)
			{
				...
				if (curSong.toLowerCase() == 'fatality' && !ClientPrefs.middleScroll)
					babyArrow.x -= 65;
				if (curSong.toLowerCase() == 'darnell wet fart' && !ClientPrefs.middleScroll && !opponentChart)
					babyArrow.x -= 310;
				if (curSong.toLowerCase() == 'black sun' && opponentChart||curStage == 'defeat' && opponentChart||curStage == 'defeatold' && opponentChart||
					curSong.toLowerCase() == 'darnell wet fart' && opponentChart)
			...
			else
			{
				...
				if (curStage == 'defeat' && !opponentChart||curStage == 'defeatold' && !opponentChart||curSong.toLowerCase() == 'black sun' && !opponentChart||
					curStage == 'ajenjenj' && !opponentChart)
					babyArrow.x -= 9999; //620

				if (curStage == 'defeat' && !ClientPrefs.middleScroll && opponentChart||curStage == 'defeatold' && !ClientPrefs.middleScroll && opponentChart||
					curSong.toLowerCase() == 'darnell wet fart' && !ClientPrefs.middleScroll && opponentChart)
					babyArrow.x += 310;
			}
			...
			if (ClientPrefs.showKeybindsOnStart && player == 1 && curSong.toLowerCase() != 'you cant run' && !opponentChart||ClientPrefs.showKeybindsOnStart && player == 0 && curSong.toLowerCase() != 'you cant run' && opponentChart) {
	...
	function winPendulum()
		{
			...
			hypnoRating.antialiasing = ClientPrefs.globalAntialiasing;
			add(hypnoRating);
	...
	override public function update(elapsed:Float)
	{
		...
		if (doingDodge && canDodgeMouse && FlxG.keys.anyJustPressed(dodgeKey) && !_onCoolDown && !cpuControlled && !dodgingMouse && !paused)
			{
				_onCoolDown = true;
				dodgingMouse = true;
		...
		if (boyfriend.animation.curAnim.name == "dodge" && !dodgingMouse)
			{ // forces anim
				boyfriend.dance();
			}
		else if (boyfriend.animation.curAnim.name != "dodge" && dodgingMouse)
			{
		...
		if (canDodge && FlxG.keys.anyJustPressed(dodgeKey))
			{
				dodging = true;
				boyfriend.playAnim('dodge', true);
				boyfriend.specialAnim = true;
		...
		if (curSong.toLowerCase() == 'recursed'||curSong.toLowerCase() == 'sunshine'||curSong.toLowerCase() == 'you cant run'||curSong.toLowerCase() == 'chaos' && curStep > 8)
			moveCameraSection();
		...
		{
			case 'extricky':
				if (exSpikes.animation.frameIndex >= 3 && boyfriend.animation.curAnim.name == 'singUP')
				{
					trace('paused');
					exSpikes.animation.pause();
				}
		...
		if (healthBarFlipped){
			iconP1.x = (opponentChart ? 593 : 0) + healthBar.x + (healthBar.width * (FlxMath.remapToRange(healthBar.percent, (opponentChart ? -100 : 100), 0, 100, 0) * 0.01) - iconOffset);
			iconP2.x = (opponentChart ? 593 : 0) + healthBar.x + (healthBar.width * (FlxMath.remapToRange(healthBar.percent, (opponentChart ? -100 : 100), 0, 100, 0) * 0.01)) - (iconP2.width - iconOffset);
		}
		else if(SONG.song.toLowerCase() == 'superscare' && opponentChart){
			iconP1.x = -983 + healthBar.x + (healthBar.width * (FlxMath.remapToRange(healthBar.percent, 0, -100, 100, 0) * 0.01)) + (150 * iconP1.scale.x - 150) / 2 - iconOffset;
			iconP2.x = -983 + healthBar.x + (healthBar.width * (FlxMath.remapToRange(healthBar.percent, 0, -100, 100, 0) * 0.01)) - (150 * iconP2.scale.x) / 2 - iconOffset * 2;	
		}
		else{
		...
		else
		{
			...
			if (pendulum != null && tranceActive) {
				...
				if (!tranceNotActiveYet) {
					...
					// /*
					if (FlxG.keys.anyJustPressed(pendulumKey) || (ClientPrefs.getGameplaySetting('botplay', false) && canHitPendulum && !alreadyHit))
					{
						if (canHitPendulum)
						{
							canHitPendulum = false;
		...
		if (curStage == 'clubroomevil' && !ClientPrefs.lowQuality)
		{
			// GO HERE DUMMY
			floatshit += 0.007;
			floatshit2 += 0.007;
			fancyclouds.alpha += Math.sin(floatshit) / 5;
			windowlight.alpha += Math.sin(floatshit2)/ 5;
			lightontopofall.alpha += Math.sin(floatshit2) / 5;
		}
	...
	function openChartEditor()
	{
		if (debugMode == true) {
		...
		else if (debugMode == false && SONG.song.toLowerCase() == 'run') {
			persistentUpdate = false;
			paused = true;
			if (tranceSound != null) tranceSound.stop();
			cancelMusicFadeTween();
			...
			#if desktop
			DiscordClient.changePresence("YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN
			YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN YOU CAN\'T RUN", null, null, true);
			#end
		}
		else if (debugMode == false && SONG.song.toLowerCase() == 'onslaught') {
			persistentUpdate = false;
			paused = true;
			if (tranceSound != null) tranceSound.stop();
			cancelMusicFadeTween();
			...
			#if desktop
			DiscordClient.changePresence("can\'t run while you are having fun", null, null, true);
			#end
		}
		else if (SONG.song.toLowerCase() == 'honorbound'||SONG.song.toLowerCase() == 'eyelander'||SONG.song.toLowerCase() == 'strongmann'){
			PlayState.SONG = Song.loadFromJson('skill-issue-tryhard6k', 'skill-issue');
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Lyrics':
				if (curStage == 'ajenjenj'){
					textFart.text = value1;
					textFart.screenCenter();
					textFart.y = healthBarBG.y - (textFart.height * 2);
				}
				else{
					if(lyrics!=null){
						remove(lyrics);
			...
			case 'Screen Shake':
				...
				for (i in 0...targetsArray.length) {
					...
					if(duration > 0 && intensity != 0) {
						...
						camNotes.shake(intensity, duration);
					}
				}
			case 'Change Mania':
				var newMania:Int = 0;
				...
				switch(charType) {
					...
					case 1:
						if(dad.curCharacter != value2) {
							...
							if(!dad.curCharacter.startsWith('gf-') && !dad.curCharacter.startsWith('gf')) {
								if(wasGf && gf != null) {
									gf.visible = true;
								}
							} else if(gf != null) {
					...
					case 3:
						if(mom.curCharacter != value2) {
							...
							var wasGf:Bool = mom.curCharacter.startsWith('gf') || mom.curCharacter == 'gf';
							var lastAlpha:Float = mom.alpha;
							mom.alpha = 0.00001;
							mom = momMap.get(value2);
							if(!mom.curCharacter.startsWith('gf-') && !mom.curCharacter.startsWith('gf')) {
								if(wasGf && gf != null) {
									gf.visible = true;
								}
							} else if(gf != null) {
			...
			case 'Change Time':
				var newTime:Float = Std.parseFloat(value1);
				var length:Float = Std.parseFloat(value2);
				if (Math.isNaN(newTime))
					newTime = FlxG.sound.music.length;
				if (Math.isNaN(length))
					length = 0;

				FlxTween.tween(this, {barSongLength: newTime}, length);

			case 'Flash Red':
				if (!ClientPrefs.flashing)
					return;
				camOther.flash(FlxColor.fromString('0xFFFF0000'), 1, null, true);
			...
			case 'Opponent Two':
				...
				if(opponent2sing){
					switch(curStage){
						case 'cargo':
							if(opponentChart)
								healthBar.createFilledBar(FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]), FlxColor.fromRGB(58,27,80));
							else
								healthBar.createFilledBar(FlxColor.fromRGB(58,27,80), FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]));    
					...
					switch(curStage){
						case 'cargo':
							if(opponentChart)
								healthBar.createFilledBar(FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]), FlxColor.fromRGB(209,210,248));
							else
								healthBar.createFilledBar(FlxColor.fromRGB(209,210,248), FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]));    
			...
			case 'HUD Fade':
				var charType:Int = Std.parseInt(value1);
				var charType2:Int = Std.parseInt(value2);
				if (Math.isNaN(charType))
					charType = 0;
				if (Math.isNaN(charType2))
					charType2 = 0;

				if (curSong.toLowerCase() == 'darnell wet fart'){
					FlxTween.tween(camHUD, {alpha: charType}, charType2, {ease: FlxEase.quadInOut});
					FlxTween.tween(camNotes, {alpha: charType}, charType2, {ease: FlxEase.quadInOut});
				}
				else{
					switch (charType)
					{
			...
			case 'Pnotefade':
				if (opponentChart){
					...
					{
						FlxTween.tween(spr, {alpha: 0.1}, 0.2, {ease: FlxEase.sineOut});
					});
				}
				else{
					playerStrums.forEach(function(spr:FlxSprite)
			...
			case 'RedVG':
				var vg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Exe/RedVG'));
				vg.alpha = 0;
				vg.cameras = [camNotes];
				add(vg);
			...
			case 'Blue':
				if(value1 == 'on'){
					...
					healthBar.color = FlxColor.fromRGB(0, 0, 255);
					healthBarBG.color = FlxColor.fromRGB(0, 0, 255);
					iconP1.color = FlxColor.fromRGB(0, 0, 255);
					iconP2.color = FlxColor.fromRGB(0, 0, 255);
					dad.color = FlxColor.fromRGB(0, 0, 255);
					boyfriend.color = FlxColor.fromRGB(0, 0, 255);
					gf.color = FlxColor.fromRGB(0, 0, 255);
					fart.color = FlxColor.fromRGB(0, 0, 255);
					fart2.color = FlxColor.fromRGB(0, 0, 255);
					sponge.color = FlxColor.fromRGB(0, 0, 255);
					sponge2.color = FlxColor.fromRGB(0, 0, 255);
				}else{
					camOther.flash(FlxColor.fromRGB(255, 59, 59), 1);
					healthBar.color = FlxColor.fromRGB(255, 255, 255);
					healthBarBG.color = FlxColor.fromRGB(255, 255, 255);
					iconP1.color = FlxColor.fromRGB(255, 255, 255);
					iconP2.color = FlxColor.fromRGB(255, 255, 255);
					dad.color = FlxColor.fromRGB(255, 255, 255);
					boyfriend.color = FlxColor.fromRGB(255, 255, 255);
					gf.color = FlxColor.fromRGB(255, 255, 255);
					fart.color = FlxColor.fromRGB(255, 255, 255);
					fart2.color = FlxColor.fromRGB(255, 255, 255);
					sponge.color = FlxColor.fromRGB(255, 255, 255);
					sponge2.color = FlxColor.fromRGB(255, 255, 255);
				}
			case 'Byeeee':
				FlxTween.tween(black, {alpha: 1}, 1.1, {onComplete: function(tmr:FlxTween){
					FlxTween.tween(camHUD, {alpha: 0}, 1.1);
					FlxTween.tween(camNotes, {alpha: 0}, 1.1);
				}});
			case 'Genesis':
				var value:Int = Std.parseInt(value1);
				if (Math.isNaN(value))
				...
				switch (value)
				{
					case 1:
						...
						generateStaticArrows(0);
						generateStaticArrows(1);
						PlayState.SONG.arrowSkin = "SONICNOTE_assets";
						sonicHUD.visible=true;
						pickle.visible = true;
						genesis.visible = false;
						triggerEventNote('Change Character', 'bf', 'bfpickel');
						triggerEventNote('Change Character', 'gf', 'gfpickel');
						triggerEventNote('Change Character', 'dad', 'pixelrunsonic');
						// dad.x = 100;
					...
					case 2:
						...
						triggerEventNote('Change Character', 'bf', ClientPrefs.bfSkin);
						triggerEventNote('Change Character', 'gf', ClientPrefs.gfSkin);
						triggerEventNote('Change Character', 'dad', 'ycr-mad');
						reloadHealthBarColors();
						healthBar.x -= 150;
						iconP1.x -= 150;
						iconP2.x -= 150;
	...
	function moveCameraSection():Void {
		...
		if (!SONG.notes[curSection].mustHitSection)
		{
			...
			if (SONG.song.toLowerCase() == 'lost cause')
				defaultCamZoom = 0.65;
			if (SONG.song.toLowerCase() == 'darnell wet fart'){
				gf.playAnim("disappear", true);
				gf.specialAnim = true;
				idk = false;
		...
		if(isDad)
		{
			...
			switch (dad.curCharacter)
			{
				...
				case 'bigmonika'|'bigmonika-dead':
					...
					camFollow.y = 300;
				case 'omen':
					camFollow.x = dad.getMidpoint().x - 135;
					camFollow.y = dad.getMidpoint().y - 350;
				case 'cheekygun'|'cheeky-scared':
	...
	public function endSong():Void
	{
		...
		if(!startingSong && SONG.song.toLowerCase() != 'fatality' && SONG.song.toLowerCase() != 'invincible') {
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['bopeebo_pfc', 'ballistic_95acc', 'ballistichq_95acc', 'madness_fc', 'expurgation_95acc', 'foolhardy_95acc', 
			'sporting_95acc', 'tooslow_95acc', 'tooslowdside_95acc', 'tooslowencore_95acc', 'endless_95acc', 'oldendless_95acc', 'cycles_fc', 'execution_fc', 
			'sunshine_95acc', 'chaos_95acc', 'faker_fc', 'blacksun_95acc', 'fatality_90acc', 'novillains_95acc', 'noheroes_95acc', 'phantasm_95acc', 'lostcause_95acc', 
			'reactor_95acc', 'doublekill_95acc', 'defeat_fc', 'heartbeat_fc', 'pretender_fc', 'insanestreamer_fc', 'idk_fc', 'torture_fc', 'sage_fc', 'infitrigger_2miss',
			'ebola_immune', 'honorbound_95acc', 'eyelander_95acc', 'strongmann_95acc', 'skillissue_unlock', 'hyperlink2_95acc', 'acceptance_fc', 'delirious_95acc', 
			'recursed_fc', 'bombastic_95acc', 'abuse_fc', 'trinity_90acc', 'iamgod_95acc', 'superscare_95acc', 'attack_95acc', 'blueballed_100', 'fourkeyonly', 
			'insanity', 'oh_god', 'run_complete', 'onslaught_95acc', 'ycr_95acc', 'tt_90acc', 'spookpostor_95acc', 'darnellfart_fc', 'platforming_fc', 'thriller_fc', 
			'fnfgirl_95acc', 'fatality_hell', 'madness_hellfc', 'hyperlink2_hellfc', 'ringcollector_100', 'invincible_95acc', 'h2b_95acc', 'eggroll_95acc', 'cornucopia_95acc', 
			'badomen_95acc', 'suffering_95acc', 'sufferingremix_95acc']);
		...
		if(ret != FunkinLua.Function_Stop && !transitioning) {
			if (SONG.validScore)
			{
				...
				if (!pussyMode && !opponentChart && !randomMode)
			...
			else
			{
				...
				else if (curSong == 'Bopeebo' && instakillOnMiss && fadeOut && fadeIn && drunkGame && !pussyMode && pendulumMode && !changedDifficulty && randomMode){
					if(!ClientPrefs.getGameplaySetting('practice', false) && !ClientPrefs.getGameplaySetting('botplay', false)) {
						StoryMenuState.weekCompleted.set(WeekData.weeksList[storyWeek], true);
						FlxG.save.data.weekCompleted = StoryMenuState.weekCompleted;
						FlxG.save.flush();
	...
	private function cachePopUpScore()
	{
		...
		if (curSong.toLowerCase() == 'unknown suffering'||curSong.toLowerCase() == 'unknown suffering remix')
			pixelShitPart2 = '-mouse';
	...
	function noteMiss(daNote:Note):Void { //You didn't hit the key and let it go offscreen, also used by Hurt Notes
		...
		if (!isRing||isRing && daNote.noteData != 3)
			combo = 0;

		if (!isRing||isRing && cNum == 0 && daNote.noteData != 3)
			health -= daNote.missHealth * healthLoss;
		else if (cNum != 0 && daNote.noteData != 3 && !opponentChart){
			cNum = 0;
			FlxG.sound.play(Paths.sound('RingLoss', 'shared'));
		}
		...
		if(char != null && !daNote.noMissAnimation && char.hasMissAnimations && !isRing||isRing && daNote.noteData != 3 && !opponentChart)
		{
	...
	function noteMissPress(direction:Int = 1):Void //You pressed a key when there was no notes to press for this key
	{
		...
		if (!boyfriend.stunned)
		{
			...
			if (curSong.toLowerCase() != 'black sun' && cNum == 0)
				health -= 0.05 * healthLoss;
	...
	{
		if (isRing && note.noteData == 3 && !note.isSustainNote && opponentChart)
			{
				FlxG.sound.play(Paths.sound('RingReal', 'shared'));
				cNum += 1;
			}
		if (!opponentChart && Paths.formatToSongPath(SONG.song) != 'tutorial' && singingTurnsOnCamZoom|| !songIsWeird)
			camZooming = true;
		...
		if(note.noteType == 'Hey!' && dad.animOffsets.exists('hey')) {
			...
			char.specialAnim = true;
			char.heyTimer = 0.6;
		} else if(!note.noAnimation && !isRing && !priAnim||isRing && note.noteData != 3) {
			...
			if(note.noteType == 'DAD & GF Sing' && !opponentChart){
				dad.playAnim(animToPlay, true);
				dad.holdTimer = 0;
			...
			if (curSong.toLowerCase() == 'cornucopia' && !opponentChart && !pussyMode){
		...
		if (healthDrainMod == false && opponentChart){
			if (health - 0.023 < 0)
				health = 0.01;
			else if (health - 0.023 > 0)
				health = health - 0.023;
		}

		if (isRing && !opponentChart){
			if (cNum > 0){
				if (health - 0.04 / cNum < 0)
					health = 0.01;
				else if (health - 0.04 / cNum > 0)
					health = health - 0.04 / cNum;
			}
			else{
				if (health - 0.04 < 0)
					health = 0.01;
				else if (health - 0.04 > 0)
					health = health - 0.04;
			}
		}
	...
	function startDodge()
		{
			...
			FlxG.sound.play(Paths.sound('Warning', 'shared'), 2);
	...
	function addCinematicBars(speed:Float, ?thickness:Float = 7)
		{
			if (cinematicBarsMouse["top"] == null)
			{
				cinematicBarsMouse["top"] = new FlxSprite(0, 0).makeGraphic(FlxG.width, Std.int(FlxG.height / thickness), FlxColor.BLACK);
				cinematicBarsMouse["top"].screenCenter(X);
				cinematicBarsMouse["top"].cameras = [camBars];
				cinematicBarsMouse["top"].y = 0 - cinematicBarsMouse["top"].height; // offscreen
				add(cinematicBarsMouse["top"]);
			}
	
			if (cinematicBarsMouse["bottom"] == null)
			{
				cinematicBarsMouse["bottom"] = new FlxSprite(0, 0).makeGraphic(FlxG.width, Std.int(FlxG.height / thickness), FlxColor.BLACK);
				cinematicBarsMouse["bottom"].screenCenter(X);
				cinematicBarsMouse["bottom"].cameras = [camBars];
				cinematicBarsMouse["bottom"].y = FlxG.height; // offscreen
				add(cinematicBarsMouse["bottom"]);
			}
	
			FlxTween.tween(cinematicBarsMouse["top"], {y: 0}, speed, {ease: FlxEase.circInOut});
			FlxTween.tween(cinematicBarsMouse["bottom"], {y: FlxG.height - cinematicBarsMouse["bottom"].height}, speed, {ease: FlxEase.circInOut});
		}
	...
	function goodNoteHit(note:Note):Void
	{
		...
		if (!note.wasGoodHit)
		{
			...
			if(note.hitCausesMiss) {
				...
				if(!note.noMissAnimation)
				{
					switch(note.noteType) {
						case 'Static Note'|'Static Note Hell': // what do you fucking think dawg
							health += 0;
						case 'Phantom Note':
						...
						case 'Majin Note':
							health += 0;
						case 'Pixel Note':
						case 'Hurt Note'|'Hurt Note Hell': //Hurt note
							if (!pussyMode){
								if(boyfriend.animation.getByName('hurt') != null) {
									boyfriend.playAnim('hurt', true);
									boyfriend.specialAnim = true;
								}
								if (curSong.toLowerCase() == 'madness')
						...
						case 'Death Note':
							...
							if (curSong.toLowerCase() == 'expergation')
			...
			if (!note.isSustainNote)
			{
				if (!isRing||isRing && note.noteData != 3){
					combo += 1;
			...
			if (!isRecursed)
				{
					if (SONG.song.toLowerCase() != 'black sun' && !isRing||!hellMode && SONG.song.toLowerCase() != 'torture'||isRing && note.noteData != 3)
						health += note.hitHealth * healthGain;
					else if (isRing && opponentChart && cNum > 0)
						health += note.hitHealth / cNum;
				}

			if(!note.noAnimation && !isRing && !priAnim||isRing && note.noteData != 3) {
				...
				if (opponentChart && !note.gfNote){
					if(opponent2sing == true||note.noteType == 'Opponent 2 Sing')
						{
							char = mom;
							mom.playAnim(animToPlay + note.animSuffix, true);
							mom.holdTimer = 0;
						}
					else
						{
	...
	function removeRecursed()
		{
			...
			if(boyfriend.curCharacter != bfVersion) {
				if(!boyfriendMap.exists(bfVersion)) {
					addCharacterToList(bfVersion, 0);
				}

				var lastAlpha:Float = boyfriend.alpha;
				boyfriend.alpha = 0.00001;
				boyfriend = boyfriendMap.get(bfVersion);
				boyfriend.alpha = lastAlpha;
				iconP1.changeIcon(boyfriend.healthIcon);
			}
	...
	override function stepHit()
	{
		...
		switch(SONG.song.toLowerCase()){
				...
				switch (curStep)
				{
					case 1:
						...
						if (!pussyMode && !opponentChart){
							...
							var keysText = getKey(dodgeKey[0]).toUpperCase()
								+ (!checkKey(getKey(dodgeKey[0])) && !checkKey(getKey(dodgeKey[1])) ? " " : "")
								+ getKey(dodgeKey[1]).toUpperCase();
	
							cutsceneText.text = "Your dodge keybinds are: %" + keysText + "%";
	
							cutsceneText.applyMarkup("Your dodge keybinds are: $" + keysText + "$",
								[new FlxTextFormatMarkerPair(new FlxTextFormat(FlxColor.fromRGB(255, 255, 0)), "$")]);
					...
					case 256:
						...
						for (obj in objs)
						{
							FlxTween.tween(obj, {alpha: 0.0001}, 0.2);
						}
					case 268:
						var objs = [
							healthBar,
						...
						singingTurnsOnCamZoom = true;

						camZooming = true;
					case 272|1488:
						defaultCamZoom = 0.67;
					case 400|800|1344|2560:
					...
					case 416|808:
						camGame.alpha = 1;
					case 1067:
						FlxTween.tween(camGame, {alpha: 0.0001}, 0.2);
						strumLineNotes.forEach(function(spr)
						{
							FlxTween.tween(spr, {alpha: 0.0001}, 0.2);
						});
						defaultCamZoom = 0.67;
					case 1092:
						strumLineNotes.forEach(function(spr)
					...
					case 1104:
						...
						FlxTween.tween(dadGroup, {alpha: 1}, 0.2);
						dadGroup.color = FlxColor.fromString('0xFF000000');
					case 1216:
						camGame.alpha = 0.0001;
						dadGroup.color = FlxColor.fromString('0xFFFFFFFF');
					case 1232:
						camGame.alpha = 1;
						thewhite.alpha = 0.0001;
						boyfriendGroup.alpha = 1;
					...
					case 1376:	
						...
						for (obj in objs)
						{
							FlxTween.tween(obj, {alpha: 0.0001}, 1);
						}
					case 1472:
						defaultCamZoom = 1;
					...
					case 2000:
						opponentStrums.forEach(function(spr)
							{
								FlxTween.tween(spr, {alpha: 0.0001}, 1);
							});
			...
			case 'unknown suffering':
				...
				switch (curStep)
				{
					...
					case 1616:
						FlxTween.tween(this, {barSongLength: FlxG.sound.music.length}, 10, {ease: FlxEase.circInOut});
		...
		if (!pussyMode && !opponentChart && !endingSong){
			if (health > 0.1){
				if (curStep >= 800){
					if (curStage == 'mugen' && FlxG.random.bool(4) && hellMode){
						new FlxTimer().start(4, function(tmr:FlxTimer)
							{
								cheekerShoot();
						});
					}
					else if (curStage == 'mugen' && FlxG.random.bool(2) && !hellMode){
						new FlxTimer().start(4, function(tmr:FlxTimer)
							{
								cheekerShoot();
						});
					...
					if (curStage == 'mugen' && FlxG.random.bool(2) && hellMode){
						new FlxTimer().start(4, function(tmr:FlxTimer)
							{
								cheekerShoot();
						});
					}
					else if (curStage == 'mugen' && FlxG.random.bool(1) && !hellMode){
						new FlxTimer().start(4, function(tmr:FlxTimer)
							{
								cheekerShoot();
						});
		...
		if (curStage == 'mugen'){
			switch (curStep){
				case 60:
					FlxTween.tween(FlxG.camera, {zoom: 0.925}, 0.25, {ease: FlxEase.quadOut});
				case 208|248|272|312|336|400|464|528|1232|1296|1360|1424:
		...
		if (curStep == 751 && curStage == 'omen'){
			...
			defaultCamZoom = 0.9;
			dad.animation.finishCallback = function(lol:String)
				{
					if (lol == 'AAAHHHHHH'){
						defaultCamZoom = 0.5;
						if (!pussyMode){
							...
							FlxTween.tween(camNotes, {angle: 180}, 1.15, {ease: FlxEase.backInOut});
							FlxTween.tween(camOther, {angle: 180}, 1.15, {ease: FlxEase.backInOut});
						}
					}
			}
		}
		...
		if (curSong == 'Chaos')
			{
				if (curStep == 16)
				{
					...
					camNotes.alpha = 0;
					if (opponentChart)
						FlxTween.tween(camNotes, {alpha: 1}, 2, {ease: FlxEase.cubeOut});
				}
				else if (curStep == 1)
				{
					boyfriendGroup.add(boyfriend);
		...
		if (curStage == 'trioStage' && SONG.song.toLowerCase()=='triple trouble')
			{
				switch (curStep)
				{
					case 152, 216, 280, 344, 536, 600, 664, 728, 920, 984, 1176, 1240, 1432, 1496, 1560, 1624, 1816, 1944, 2008, 2072, 2136, 2200, 2264, 2584, 2648, 2712,
					2776, 2968, 3032, 3096, 3160, 3224, 3288, 3352, 3416, 3480, 3544, 3608, 3672, 3736, 3800, 3864, 3928, 4120, 4184, 4248, 4312, 4376, 4440, 4504, 4568,
					4632, 4696, 4760, 4824, 4888, 4952, 5016, 5080:
						strumLineNotes.forEach(function(tospin:FlxSprite)
							{
								FlxTween.angle(tospin, 0, 360, 0.2, {ease: FlxEase.quintOut});
							});
					case 1:
						...
						FlxTween.tween(camNotes, {alpha: 1}, 2.5, {ease: FlxEase.quadInOut});

						if (opponentChart){
							FlxTween.tween(playerStrums.members[3], {x: 9999}, 0.000001, {ease: FlxEase.quartInOut});

							FlxTween.tween(playerStrums.members[0], {x: playerStrums.members[0].x + 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(playerStrums.members[1], {x: playerStrums.members[1].x + 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(playerStrums.members[2], {x: playerStrums.members[2].x + 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(playerStrums.members[4], {x: playerStrums.members[4].x - 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(playerStrums.members[5], {x: playerStrums.members[5].x - 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(playerStrums.members[6], {x: playerStrums.members[6].x - 40}, 0.000001, {ease: FlxEase.quartInOut});
						}
						else{
							FlxTween.tween(opponentStrums.members[3], {x: 9999}, 0.000001, {ease: FlxEase.quartInOut});

							FlxTween.tween(opponentStrums.members[0], {x: opponentStrums.members[0].x + 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(opponentStrums.members[1], {x: opponentStrums.members[1].x + 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(opponentStrums.members[2], {x: opponentStrums.members[2].x + 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(opponentStrums.members[4], {x: opponentStrums.members[4].x - 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(opponentStrums.members[5], {x: opponentStrums.members[5].x - 40}, 0.000001, {ease: FlxEase.quartInOut});
							FlxTween.tween(opponentStrums.members[6], {x: opponentStrums.members[6].x - 40}, 0.000001, {ease: FlxEase.quartInOut});
						}
					case 16:
					...
					case 783:
						supersuperZoomShit = false;
					case 1024, 1088, 1216, 2304, 2816, 3200, 3456, 4096, 5120:
						goofyAhhStatic(1);
					case 1040:
						timeBar.createFilledBar(0x00D416E3, 0xFFD416E3);
						timeBar.updateBar();
						...
						sky.visible = false;
						backbush.visible = false;
						treeback.visible = false;
						topbushes.visible = false;
						fgTree1.visible = false;
						fgTree2.visible = false;
						sky.active = false;
						backbush.active = false;
						treeback.active = false;
						topbushes.active = false;
						...
						backtreesXeno.active = true;
						grassXeno.active = true;
						p3staticbg.active = true;

						if (health > 1||opponentChart && health < 1)
							health = 1;

						if (opponentChart)
							FlxTween.tween(opponentStrums.members[3], {alpha: 0.25}, 0.0001, {ease: FlxEase.quartInOut});
						else
							FlxTween.tween(playerStrums.members[3], {alpha: 0.25}, 0.0001, {ease: FlxEase.quartInOut});

						triggerEventNote('Change Character', 'dad', 'BEAST');
						triggerEventNote('Change Character', 'bf', 'bf-perspective-right');
					case 1072:
						vg = new FlxSprite().loadGraphic(Paths.image('Exe/RedVG'));
						vg.alpha = 0;
						vg.cameras = [camNotes];
						add(vg);
					...
					case 1280:
						goofyAhhStatic(1);
						if (opponentChart)
							FlxTween.tween(opponentStrums.members[3], {alpha: 1}, 0.5, {ease: FlxEase.quartInOut});
						else
							FlxTween.tween(playerStrums.members[3], {alpha: 1}, 0.5, {ease: FlxEase.quartInOut});
					case 1296:
						...
						fgTree1.visible = true;
						fgTree2.visible = true;
						sky.active = true;
						backbush.active = true;
						treeback.active = true;
						topbushes.active = true;
						fgTree1.active = true;
						fgTree2.active = true;
						...
						triggerEventNote('Change Character', 'dad', 'knux');
						triggerEventNote('Change Character', 'bf', 'bf-mirror');

						healthBarFlipped = true;
						iconP2.changeIcon('bf');
						iconP1.changeIcon('knuckles');
						reloadHealthBarColors();	
						healthBarBG.sprTracker = flippedHealthBar;
						flippedHealthBar.alpha = 1;
						healthBar.alpha = 0;
					...
					case 2320:
						...
						triggerEventNote('Change Character', 'dad', 'BEAST-RIGHT');
						triggerEventNote('Change Character', 'bf', 'bf-perspective-left');
						iconP2.changeIcon('bf');
						iconP1.changeIcon('BEAST');
					case 2823:
						...
						if (opponentChart)
							FlxTween.tween(opponentStrums.members[3], {alpha: 1}, 0.0001, {ease: FlxEase.quartInOut});
						else
							FlxTween.tween(playerStrums.members[3], {alpha: 1}, 0.0001, {ease: FlxEase.quartInOut});
	
						spookyJumpscareAAA("egg");
						triggerEventNote('Change Character', 'dad', 'eggdick');
						...
						opponentStrums.forEach(function(spr:FlxSprite)
							{
								if (!ClientPrefs.middleScroll){
									if (opponentChart)
										FlxTween.tween(spr, {x: spr.x + 620}, 0.5, {ease: FlxEase.quadInOut});
									else
										FlxTween.tween(spr, {x: spr.x - 620}, 0.5, {ease: FlxEase.quadInOut});
								}
								//spr.x -= 620;
		...
		if (SONG.song.toLowerCase() == 'acceptance')
			{
				...
				if (ClientPrefs.downScroll)
				{
					...
					DrawingMom.antialiasing = ClientPrefs.globalAntialiasing;
				...
				if (ClientPrefs.downScroll)
				{
					...
					DrawingDemon.antialiasing = ClientPrefs.globalAntialiasing;
				...
				if (ClientPrefs.downScroll)
				{
					...
					DrawingDemon2.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'infitrigger':
				if (!pussyMode){
						if (opponentChart){
							...
							{
								case 1776:
									FlxTween.tween(playerStrums.members[0], {x: playerStrums.members[5].x}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[1], {x: playerStrums.members[4].x}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[2], {x: playerStrums.members[3].x}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[3], {x: playerStrums.members[2].x}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[4], {x: playerStrums.members[1].x}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[5], {x: playerStrums.members[0].x}, 0.1, {ease: FlxEase.quartInOut});
			
									FlxTween.tween(playerStrums.members[0], {angle: playerStrums.members[0].angle + 180}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[1], {angle: playerStrums.members[1].angle + 180}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[2], {angle: playerStrums.members[2].angle + 180}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[3], {angle: playerStrums.members[3].angle + 180}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[4], {angle: playerStrums.members[4].angle + 180}, 0.1, {ease: FlxEase.quartInOut});
									FlxTween.tween(playerStrums.members[5], {angle: playerStrums.members[5].angle + 180}, 0.1, {ease: FlxEase.quartInOut});
							}
						}
						else{
							switch (curStep)
			...
			case 'lost cause':
				switch (curStep)
				{
					case 1:
						...
						if (opponentChart)
							healthBar.createFilledBar(FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]),FlxColor.fromRGB(49, 176, 209));
						else
					...
					case 304:
						...
						new FlxTimer().start(4.35, function(tmr:FlxTimer){		
								...
								bfdeadlol.x -= 95;
								bfdeadlol.y += 935;
								bfdeadlol.antialiasing = ClientPrefs.globalAntialiasing;
								add(bfdeadlol);
						});
					case 2128:
						dadGroup.visible = false;
	...
	override function beatHit()
	{
		...
		if (curSong.toLowerCase() == 'platforming'){
			if (curBeat == 176||curBeat == 377){
				iconP1.changeIcon('ultrairios');
				iconP2.changeIcon('jon');
			}
		}
		...
		if (curSong.toLowerCase() == 'onslaught' && curBeat >= 128 && curBeat <= 352 )
			{
				...
				if (FlxG.random.bool(amount) && appearscreen && !pussyMode)
				{
					...
					randomthing.loadGraphic(Paths.image('bob/PopUps/popup' + FlxG.random.int(1,9), 'shared'));
					randomthing.updateHitbox();
					randomthing.alpha = 0;
					randomthing.antialiasing = ClientPrefs.globalAntialiasing;
					add(randomthing);
					randomthing.cameras = [camOther];
					appearscreen = false;
		...
		if (curBeat % gfSpeed == 0 && curStage == 'hellstage' && !pussyMode)
		{
		...
		switch (curStage)
		{
			...
			case 'warehouse':
				...
				if(curBeat == 272){
					camZooming = true;
					if (opponentChart)
						FlxTween.tween(instance, {health: 1.95, bladeDistance: 150}, 4*Conductor.crochet/1000, {ease: FlxEase.quartOut});
					else
			...
			case 'mugen':
				bottomBoppersCheek.animation.play('idle', true);
		...
		if (curSong.toLowerCase() == 'epiphany')
			{
				switch (curBeat)
				{
					...
					case 788:
						...
						for (i in 0...6)
							{
								FlxTween.tween(opponentStrums.members[i], {alpha: 0}, CoolUtil.calcSectionLength(0.25), {ease: FlxEase.sineOut});
							}
					case 790:
						dad.visible = false;
						camGame.fade(FlxColor.BLACK, 0.7 / playbackRate, false);
				}
			}
	}
	...
	override function sectionHit()
	{
		...
		if (SONG.notes[curSection] != null)
		{
			...
			{
				if (curSong.toLowerCase() != 'recursed'|| curSong.toLowerCase() != 'you cant run')
					moveCameraSection();
			}
	...
	function swageffect(){
		...
		blood.frames = Paths.getSparrowAtlas('cheeky/Effects_Assets');
		...
		FlxTween.tween(blood, {alpha: 0.0001}, 0.5, {ease: FlxEase.expoInOut});	
	}
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				switch(achievementName)
				{
					...
					case 'oh_god':
						if(Paths.formatToSongPath(SONG.song) == 'bopeebo' && instakillOnMiss && fadeOut && fadeIn && drunkGame && !pussyMode && pendulumMode && randomMode && !usedPractice && !changedDifficulty) {
							unlock = true;
							GameJoltAPI.getTrophy(196766);
						}
					...
					case 'madness_hellfc':
						if(Paths.formatToSongPath(SONG.song) == 'madness' && hellMode && songMisses < 1 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196767);
						}
					...
					case 'run_complete':
						if(Paths.formatToSongPath(SONG.song) == 'run' && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196768);
						}
					case 'onslaught_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'onslaught' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196769);
						}
					case 'h2b_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'hard-2-break' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(202627);
						}
					case 'eggroll_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'bad-eggroll' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(202629);
						}
					case 'cornucopia_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'cornucopia' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(202625);
						}
					case 'badomen_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'bad-omen' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(202630);
						}
					case 'tooslow_95acc':
					...
					case 'ycr_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'you-cant-run' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196770);
						}
					case 'tt_90acc':
						if(Paths.formatToSongPath(SONG.song) == 'triple-trouble' && ratingPercent >= 0.90 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196771);
						}
					case 'ringcollector_100':
						if(Paths.formatToSongPath(SONG.song) == 'triple-trouble' && cNum == 100 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196772);
						}
					...
					case 'fatality_hell':
						if(Paths.formatToSongPath(SONG.song) == 'fatality' && hellMode && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196773);
						}
					case 'epiphany_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'epiphany' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196774);
						}
					...
					case 'invincible_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'invincible' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(202623);
						}
					...
					case 'spookpostor_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'spookpostor' && ratingPercent >= 0.98 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196775);
						}
					...
					case 'suffering_95acc':	
						if(Paths.formatToSongPath(SONG.song) == 'unknown-suffering' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode && !pussyMode) {
							unlock = true;
							GameJoltAPI.getTrophy(206829);
						}		
					case 'sufferingremix_95acc':	
						if(Paths.formatToSongPath(SONG.song) == 'unknown-suffering-remix' && ratingPercent >= 0.95 && !usedPractice && !changedDifficulty && !opponentChart && !randomMode && !pussyMode) {
							unlock = true;
							GameJoltAPI.getTrophy(206831);
						}													
					case 'sage_fc':
					...
					case 'skillissue_unlock':
						if(Paths.formatToSongPath(SONG.song) == 'skill-issue' && !usedPractice) {
							unlock = true;
							GameJoltAPI.getTrophy(196776);
						}
					case 'darnellfart_fc':
						if(Paths.formatToSongPath(SONG.song) == 'darnell-wet-fart' && songMisses < 1 && !usedPractice && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196777);
						}
					...
					case 'hyperlink2_hellfc':
						if(Paths.formatToSongPath(SONG.song) == 'HYPERLINK-RELOADED' && songMisses < 1 && !usedPractice && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196778);
						}
					case 'acceptance_fc':
					...
					case 'platforming_fc':
						if(Paths.formatToSongPath(SONG.song) == 'platforming' && songMisses < 1 && !usedPractice && !pussyMode && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196779);
						}
					case 'thriller_fc':
						if(Paths.formatToSongPath(SONG.song) == 'thriller-gen' && songMisses < 1 && !usedPractice && !pussyMode && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196780);
						}
					case 'trinity_90acc':
					...
					case 'fnfgirl_95acc':
						if(Paths.formatToSongPath(SONG.song) == 'fnfgirl' && ratingPercent >= 0.95 && !usedPractice && !pussyMode && !opponentChart && !randomMode) {
							unlock = true;
							GameJoltAPI.getTrophy(196781);
						}
					case 'attack_95acc':
	...
	function spookyJumpscareAAA(char:String)
		{
			switch (char)
			{
				case "tails":
					trace('SIMPLE JUMPSCARE');
					var doP3JumpTAILS:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Exe/JUMPSCARES/Tails'));
					doP3JumpTAILS.setGraphicSize(FlxG.width, FlxG.height);
					doP3JumpTAILS.screenCenter();
					doP3JumpTAILS.cameras = [camNotes];
				...
				case "knux":
					trace('SIMPLE JUMPSCARE');
					var doP3JumpKNUX:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Exe/JUMPSCARES/Knuckles'));
					doP3JumpKNUX.setGraphicSize(FlxG.width, FlxG.height);
					doP3JumpKNUX.screenCenter();
					doP3JumpKNUX.cameras = [camNotes];
				...
				case "egg":
					trace('SIMPLE JUMPSCARE');
					var doP3JumpEGG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Exe/JUMPSCARES/Eggman'));
					doP3JumpEGG.setGraphicSize(FlxG.width, FlxG.height);
					doP3JumpEGG.screenCenter();
					doP3JumpEGG.cameras = [camNotes];
	...
	function goofyAhhStatic(poopahahahaa:Float)
		{
			switch (poopahahahaa)
			{
				case 1:
					...
					var daP3Static:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Exe/Phase3Static'));
