...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		var leText:String = "Press RESET to Reset your achievements.";
		var size:Int = 18;
	...
	override function update(elapsed:Float) {
		...
		var smoething:String = Achievements.achievementsStuff[achievementIndex[curSelected]][2];
		if (controls.UI_UP_P) {
			changeSelection(-1);
		}
		...
		if(controls.RESET)
			{
				openSubState(new ResetAchievementSubState(smoething));
